...
- focused contract（CoordinationStore、Leader admission、ingress、OpenClaw hook、outbox、Matrix channel）共 29 Worker tests 全部通过，App projection 3 tests 全部通过；这证明的是纯 Worker seam 和 replay/idempotency，不是 AgentTeams 真实部署 smoke。
