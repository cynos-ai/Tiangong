...
// by itself: the Docker executor enforces this boundary locally, but no
// model-facing executor is active until a closed Worker adapter proves the same
// mounts, credentials, ownership, and network boundaries in the real stack.
// cwd is only an initial directory, not a path-isolation policy.
