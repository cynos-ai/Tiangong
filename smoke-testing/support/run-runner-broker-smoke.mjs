...
const brokerImage = process.env.TIANGONG_RUNNER_BROKER_IMAGE ?? "tg-runner-broker:dev";
const workerImage = process.env.TIANGONG_RUNNER_IMAGE ?? "tg-worker:dev";
const assessorImage = process.env.TIANGONG_REVIEWER_IMAGE ?? "tg-worker:dev";
