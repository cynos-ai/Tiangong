...
readonly REPO_ROOT
readonly TEAM_NAME="${TIANGONG_SMOKE_TEAM_NAME:-tiangong-leader-smoke}"
readonly LEADER_NAME="${TIANGONG_SMOKE_LEADER_NAME:-${TEAM_NAME}-leader}"
readonly DESIGNER_NAME="${TIANGONG_SMOKE_DESIGNER_NAME:-${TEAM_NAME}-designer}"
readonly IMPLEMENTOR_NAME="${TIANGONG_SMOKE_IMPLEMENTOR_NAME:-${TEAM_NAME}-implementor}"
readonly ASSESSOR_NAME="${TIANGONG_SMOKE_ASSESSOR_NAME:-${TEAM_NAME}-assessor}"
readonly OPERATOR_NAME="${TIANGONG_SMOKE_OPERATOR_NAME:-${TEAM_NAME}-operator}"
...
readonly WORKERS_MANIFEST="${TIANGONG_SMOKE_WORKERS_MANIFEST:-${REPO_ROOT}/smoke-testing/fixtures/leader-smoke-workers.yaml}"
readonly MANIFEST="${TIANGONG_SMOKE_TEAM_MANIFEST:-${REPO_ROOT}/smoke-testing/fixtures/leader-smoke-team.yaml}"
